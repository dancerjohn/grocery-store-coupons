...
public class CategoryProductMatcherTest {
	...
	private final CategoryProductMatcher matcher = new CategoryProductMatcher(
			matchProduct.getCategory());
	...
	public void testSingleProductMatcher_nullProduct() {
		...
		// test
		new CategoryProductMatcher(null);
	}
	...
	public void testSetProductToMatch() {
		...
		// test
		matcher.setCategoryToMatch(null);
	}
